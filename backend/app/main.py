...
from app.routers import profile, assessment, careers, roadmap, progress, activity, skills, dashboard, user_skills, chat
...
app.include_router(user_skills.router, tags=["User Skills"])
